...
const LobbyHeader = () => {
  return (
    <div class="p-4" className="lg:flex lg:items-center lg:justify-between">
      <div className="flex-1 min-w-0">
        <h2 className="p-2 text-2xl font-bold leading-7 text-gray-900 sm:text-3xl sm:truncate">Business Technology Management</h2>
